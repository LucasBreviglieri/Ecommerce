...
<div class="container py-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <button class="btn btn-primary btn-sm adicionar-carrinho" data-product-id="{$P.pro_id}"
                                    data-product-name="{$P.pro_nome}" data-product-desc="{$P.pro_desc}"
    ...
    {if $PRO_TOTAL < 1} <H4 class="alert alert-danger">NENHUM PRODUTO ENCONTRADO !</H4>
        {/if}
</div>
</div>
